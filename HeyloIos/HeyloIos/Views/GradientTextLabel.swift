...
class GradientTextLabel: UILabel {
    ...
    private let containerLayer = CALayer()  // Add container layer
    ...
    private func setupGradient() {
        ...
        // Set text color to clear to show gradient
        textColor = .clear
    }
    ...
    override func layoutSubviews() {
        ...
        if let text = text {
            ...
            if let image = UIGraphicsGetImageFromCurrentImageContext() {
                ...
                let padding: CGFloat = 100  // Add padding around the text
                containerLayer.frame = CGRect(x: -padding, y: -padding, 
                                           width: bounds.width + padding * 2, 
                                           height: bounds.height + padding * 2)
                
                // Center the mask layer in the container
